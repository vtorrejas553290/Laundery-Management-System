                ...
                <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                    @php
                        $navigation = [
                            ...
                            ['name' => 'Customers', 'route' => 'admin.customers', 'icon' => 'users'],
                            ['name' => 'Services', 'route' => 'admin.services', 'icon' => 'shirt'],
                            ['name' => 'Categories', 'route' => 'admin.service-categories', 'icon' => 'category'],
                            ['name' => 'Staff', 'route' => 'admin.staff', 'icon' => 'staff'],
                            ['name' => 'Transactions', 'route' => 'admin.transactions', 'icon' => 'receipt'],
                            ['name' => 'Payments', 'route' => 'admin.payments', 'icon' => 'payment'],
                            ['name' => 'Extra Items', 'route' => 'admin.extra-items', 'icon' => 'package'],
                        ];
                    @endphp
                    ...
                    @foreach($navigation as $item)
                        ...
                        >
                            ...
                            @elseif($item['icon'] == 'category')
                                <!-- Category Icon - Folder/Grid icon for categories -->
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
