<x-app-layout>
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-600">{{ $category->serviceTypes->count() }}</td>
                                    <td class="px-4 py-3 text-right">
                                        <div class="flex justify-end gap-2">
    ...
    <!-- View Service Modal - WIDER VERSION -->
    ...
    <!-- View Category Modal - WIDER VERSION -->
    ...
    <script>
        ...
        async function viewService(id) {
            try {
                ...
                // Store current service for edit button
        ...
        async function viewCategory(id) {
            try {
                ...
                // Get description - handle null, undefined, or empty string
                let description = category.description;
                
                // Check if description exists and is not null/undefined/empty
                ...
                // Store current category for edit button
        ...
        document.addEventListener('keydown', function(event) {
            if (event.key === 'Escape') {
                ...
                if (viewServiceModal.style.display === 'block') {
                    closeViewServiceModal();
                }
                if (categoryModal.style.display === 'block') {
                    closeCategoryModal();
                }
                if (viewCategoryModal.style.display === 'block') {
                    closeViewCategoryModal();
                }
            }
        });
